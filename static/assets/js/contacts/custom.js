function submitContact() {
  if ($("#bookmark-form").valid()) {
    ...
    var tablist =
      '	<a class="contact-tab-' +
      index_var +
      ' nav-link active" id="v-pills-user-tab" data-toggle="pill" onclick="activeDiv(' +
      index_var +
      ')" href="#v-pills-user" role="tab" aria-controls="v-pills-user" aria-selected="true" data-original-title="" title="">\
			                <div class="media">\
				                <img class="img-50 img-fluid m-r-20 rounded-circle update_img_0" src="/wingo/wingoapp/static/assets/images/user/user.png" alt="" data-original-title="" title="">\
    ...
    var tabcontent =
      '<div class="tab-pane contact-tab-' +
      index_var +
      ' tab-content-child fade show active" id="v-pills-user" role="tabpanel" aria-labelledby="v-pills-user-tab">\
		                <div class="profile-mail">\
		                  <div class="media">\
		                  <img class="img-100 img-fluid m-r-20 rounded-circle update_img_0" src="/wingo/wingoapp/static/assets/images/user/user.png" alt="" data-original-title="" title="">\
      ...
      '</p>\
		                      <ul>\
		                        <li><a href="#" onclick="editContact(' +
      index_var +
      ')" data-original-title="" title="">Edit</a></li>\
		                        <li><a href="#" onclick="deleteContact(' +
      index_var +
      ')" data-original-title="" title="">Delete</a></li>\
		                        <li><a href="#" onclick="history(' +
      index_var +
      ')" data-original-title="" title="">History</a></li>\
		                        <li><a href="#" onclick="printContact(' +
      index_var +
      ')" data-toggle="modal" data-target="#printModal" data-original-title="" title="">Print</a></li>\
		                      </ul>\
		                    </div>\
		                  </div>\
		                  <div class="email-general">\
		                    <h6>General</h6>\
		                    <p>Email Address: <span class="font-primary email_add_' +
      index_var +
      '">' +
      mail +
      "</span></p>\
